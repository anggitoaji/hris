  ...
  return (
    <Card title="Meeting (MoM)" action="Lihat Semua" className="h-full">
      <div className="flex flex-col gap-2">
        {MEETINGS.map((m, i) => (
          <div key={i} className="flex items-center gap-3 border border-slate-100 rounded-xl p-2">
            <div className="flex items-center justify-center rounded-lg shrink-0" style={{ width: 28, height: 28, background: "#ede9fe" }}>
