      ...
      <div className="flex flex-col gap-2.5">
        {PROJECTS.map((p, i) => (
          <div key={i} className="flex items-start gap-3">
            <div className="flex items-center justify-center rounded-xl shrink-0 mt-0.5" style={{ width: 30, height: 30, background: "#f1f5f9" }}>
              <ClipboardCheck size={16} color={p.color} />
            </div>
